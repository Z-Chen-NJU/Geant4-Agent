...
def _build_strict_slot_prompt_v2(user_text: str, context_summary: str) -> str:
    return (
        ...
        '- User: "radius 5 mm, height 20 mm copper cylinder"\n'
        '  JSON slots.geometry may stay partial, but JSON candidates.geometry = {"kind_candidate":"cylinder","radius_mm":5,"full_length_mm":20}\n'
        '- User: "20 mm diameter copper cylinder"\n'
        '  JSON slots.geometry may stay partial, but JSON candidates.geometry = {"kind_candidate":"cylinder","diameter_mm":20}\n'
        '- User: "5 cm lead sphere"\n'
        ...
        '  JSON candidates.source = {"relation":"in_front_of_target","offset_mm":5,"axis":"-z","direction_mode":"toward_target_face_normal"}\n'
        '- User: "20 mm upstream of target along -z"\n'
        '  JSON candidates.source = {"relation":"upstream_of_target","offset_mm":20,"axis":"-z","direction_mode":"toward_target_face"}\n'
        '- User: "5 mm from the target surface along -z"\n'
        '  JSON candidates.source = {"relation":"in_front_of_target","offset_mm":5,"axis":"-z","direction_mode":"toward_target_face"}\n'
        '- User: "point source at (0,0,-20) mm toward target center"\n'
