...
def _build_strict_slot_prompt_v2(user_text: str, context_summary: str) -> str:
    return (
        ...
        '  },\n'
        '  "candidates": {\n'
        '    "geometry": {"kind_candidate": "box|cylinder|sphere|orb|cons|trd|polycone|polyhedra|cuttubs|trap|para|torus|ellipsoid|elltube|null", "side_length_mm": null, "radius_mm": null, "half_length_mm": null, "full_length_mm": null},\n'
