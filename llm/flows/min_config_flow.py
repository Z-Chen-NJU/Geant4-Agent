...
def generate_min_config(
    user_text: str,
    schema_path: str = "llm/schema/geant4_min_config.schema.json",
    system_path: str = "llm/prompts/min_config_system.txt",
    ollama_config: str = "bert_lab/ollama_config.json",
) -> Dict[str, Any]:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--schema", default="llm/schema/geant4_min_config.schema.json")
    parser.add_argument("--system", default="llm/prompts/min_config_system.txt")
