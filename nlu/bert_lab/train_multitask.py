...
def _generate_llm_samples(n: int, ollama_config: str) -> List[Sample]:
    prompt = (
        ...
        "Structure must be one of: nest, grid, ring, stack, shell, single_box, single_tubs, single_sphere, single_cons, single_trd, single_polycone, single_cuttubs, boolean, unknown.\n"
